export class NeatConfig {
  ...
  public static readonly PROBABILITY_MUTATE_LINK = 0.05;
  public static readonly PROBABILITY_MUTATE_NODE = 0.05;
  public static readonly PROBABILITY_MUTATE_WEIGHT_SHIFT = 0.05;
  public static readonly PROBABILITY_MUTATE_WEIGHT_RANDOM = 0.05;
